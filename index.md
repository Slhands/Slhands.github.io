...
## 1.요구사항
- 게임뷰는 1인칭이며 자유롭게 이동가능합니다
- 앉기 기능이 있습니다.
- 책상 위의 책과 같은 문서는 상호작용이 가능합니다.
- 첫번째 스테이지는 학교를 배경으로 구현합니다
- 첫번째 스테이지는 복층으로 구조는 각각 다르게 배치합니다
- 첫번째 스테이지에서 주요npc와 상호작용 하는것으로 두번째 스테이지로 이동합니다
- 첫번째 스테이지에서 에너미와 조우합니다
- 에너미와 조우할경우 게임오버됩니다.
- 에너미는 달릴수없게 설정합니다
- 플레이어의 속도는 에너미보다 아주 살짝 빠르게 설정합니다
- 첫번째 스테이지의 교무실에서 저장이 가능하도록 구현합니다.
- 게임내의 오브젝트는 플레이어와 상호작용시 효과음을 추가합니다.
- 가능한 부분까지 모델은 수제작합니다.
- 플레이어는 달릴수없게 설정합니다.
- 책상,교탁,벽뒤 등등 에너미의 시야에 장애물이 있으면 플레이어를 인식하지 못하도록 구현합니다.
